...
%% mit den aktuellen EN/GER-Versionen (KI_Elite_v2_en.tex / _ger.tex).
...
% TODO: English main text (translation needed)
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c l}
    ...
    D08 Zukunftsoptimismus   & 8 & Sehr hoch \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l c c c l}
    ...
    D08 Zukunftsoptimismus      & 8 & 9 & $+1$ & Handeln $>$ Sagen \\
...
\bibitem[Baker et~al.(2009)]{BakerSaxeTenenbaum2009}
  Baker, C.~L., Saxe, R.~\& Tenenbaum, J.~B. (2009).
  Action understanding as inverse planning.
  \textit{Cognition}, \textit{113}(3), 329--349.

...
\noindent Die vollst\"andige Prompt-Bibliothek einschlie\ss{}lich Synthese-Prompts (Op1), Rating-Prompts (Op2), Kreuzmodal-Prompts (Op4a/Op4b) und Dialog-Prompts (Op6) ist im Repository archiviert (\texttt{prompts/en/}). F\"ur eine allgemeine Diskussion der Prompt-Design-Rationale siehe \citet{Geiger2026SWR}.

...
The study makes a threefold contribution. \emph{Methodologically:} To address the research questions, the study develops synthetic worldview reconstruction (SWR; see Section~\ref{sec:methodik}) -- an LLM-assisted method for reconstructing collective belief systems from group-aggregated data -- and applies it concurrently to the empirical material of this study. \emph{Empirically:} It provides the first systematic worldview analysis of the AI elite as a structured collective, based on 3,132 data points spanning 16 years and differentiated across 9~systematic inter-group comparisons (by role, stance, gender, company, epoch). \emph{Societally:} It creates a foundation for informed public deliberation by revealing the collective ideological patterns -- trends, group differences, say-do gaps -- that shape AI governance and design decisions.

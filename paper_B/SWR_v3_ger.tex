...
\begin{enumerate}[nosep]
  \item \textbf{Methodenformalisierung:} Es beschreibt SWR als \"ubertragbares F\"unfschritte-Protokoll mit expliziten Qualit\"atskriterien und grenzt es von verwandten Ans\"atzen ab (LLM-als-Teilnehmer, synthetische Datengenerierung, automatisierte Kodierung).
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{} p{2.5cm} p{2.0cm} p{2.0cm} p{2.0cm} p{2.0cm} p{2.0cm} @{}}
    \toprule
    \textbf{Merkmal} & \textbf{SWR} & \textbf{Thematische Analyse} & \textbf{Survey} & \textbf{LLM-as-Participant} & \textbf{Automatisierte Kodierung} \\
    \midrule
    Datenquelle & \"Offentl. \"Au\ss{}erungen + Handlungen & Interviews, Texte & Direkte Antworten & LLM-generiert & Bestehende Texte \\[3pt]
    Analyseeinheit & Gruppe & Variabel & Individuum & Simuliertes Individuum & Dokument \\[3pt]
    Zugang zu Befragten erforderlich & Nein & Ja & Ja & Nein & Nein \\[3pt]
    Erfasst Koh\"arenz & Ja & Teilweise & Nein & Begrenzt & Nein \\[3pt]
    Skalierbar & Ja & Begrenzt & Ja & Ja & Ja \\[3pt]
    Externe Validierung & Modal.\"ubergr. & Member Checking & Test--Retest & Demograf. Passung & Experten-Kodierung \\[3pt]
    Prim\"ares Risiko & Koh\"arenzverzerrung & Forscherverzerrung & Antwortverzerrung & Stereotyp-Reproduktion & Kontextverlust \\
    \bottomrule
  \end{tabular}
\end{table}

#!/usr/bin/env python3
"""
Erstellt die SQLite-Datenbank fuer die Aussagensammlung der Top 100 KI-Persoenlichkeiten.
...
# Falls DB schon existiert, loeschen und neu erstellen
...
cur.executescript("""
-- Personen (aus Top-100-Recherche)
...
-- Plattformen (YouTube, Twitter/X, Reddit, etc.)
...
-- Quellentypen (Video, Post, Interview, Buch, etc.)
...
-- Kategorien (WV, SB, MB, ET, GE, RI, FO, MA, AR, TR, RE, SP + sekundaere)
...
-- Suchprotokolle (Dokumentation jeder Suche)
...
cur.executescript("""
-- Komplettansicht einer Aussage mit Person, Plattform, Quellentyp
...
-- Aussagen mit zugeordneten Kategorien (eine Zeile pro Kategorie-Zuordnung)
